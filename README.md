...
These soundtracks were then imported into p5.js and are played when prompted in my interactive browser-friendly project, Tun'd In. 

The link to my project https://editor.p5js.org/sophia1234999/sketches/GoTfQwII3 

When you click on the link, you are greeted with my code behind the project. To see the final product, click (with the mouse) the red play button in the top left corner, and it will appear on the right-hand side. 
